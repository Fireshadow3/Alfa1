...
public class CleanFile {
	...
	public int numbersOfAnagramsInAnArrayList(ArrayList<String> input_ArrayList, String word) {
		int counter = 0;
		// ArrayList anagrammi
		ArrayList<String> anagrams = anagramGenerator(word);
	...
	public ArrayList<String> estrazione(ArrayList<String> input_ArrayList, String input_firstWord, String input_lastWord) {
	...
	public int[] frequencyOfAlphabetLetterInDictionaryFromAWordToAnother(ArrayList<String> input_ArrayList, String input_firstWord, String input_lastWord) {
		...
		brutto = estrazione(input_ArrayList, input_firstWord, input_lastWord);
		
		for (String element : brutto) {
			element = element.toLowerCase();
				for(int k = 0; k < element.length(); k++, CleanFile.TotalLettersInDictionary++) {
					switch(element.charAt(k)) {
					case 'a':
